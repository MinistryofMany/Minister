import { knownBadgeTypes } from "@tessera/shared";

// OIDC discovery / issuer config. The OIDC `issuer` is the URL Tessera
...
export function getOidcDiscovery(): OidcDiscovery {
  ...
  return {
    ...
    // Public sub-types intentionally absent — Tessera's whole point is
    ...
    claims_supported: ["sub", "iss", "aud", "iat", "exp", "nonce", "name", "picture", "tessera_badges"],
  };
}
