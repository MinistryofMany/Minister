...
// GitHub redirects the user here after authorize. We resolve the
...
export default async function GithubCallbackPage({ searchParams }: PageProps) {
  ...
  if (!session?.user) {
    return (
      <Shell title="Sign in to finish">
        <CardDescription>
          You came back from GitHub but aren&apos;t signed in to Tessera here.
  ...
  if (result.kind === "complete") {
    redirect("/profile?issued=github");
  }
  ...
  return (
    <Shell title="GitHub flow failed">
