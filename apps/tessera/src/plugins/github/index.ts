...
export const githubPlugin: Plugin = {
  manifest: {
    ...
    name: "GitHub",
    description:
      "Prove you control a GitHub account. Issues an `oauth-account` badge with the GitHub user id and handle, signed by Tessera.",
    ...
    return {
      ...
      currentStep: {
        ...
        payload: {
          ...
          description:
            "We'll send you to GitHub to authorize this badge. After you approve, you'll bounce back here and Tessera will issue the credential.",
          expectedState: state,
        },
      },
