...
import type { Plugin, WizardState } from "@tessera/plugin-sdk";
...
export const inviteCodePlugin: Plugin = {
  manifest: {
    ...
    name: "Invite code",
    description:
      "Redeem an invite code from a Tessera admin. The badge names the campaign you were invited to — the code itself is never stored in the credential.",
