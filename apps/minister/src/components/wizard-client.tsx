...
function ExtensionActionStep({ payload }: { payload: ExtensionActionStepPayload }) {
  ...
  return (
    <>
      <CardHeader>
        <CardTitle>Use the Minister browser extension</CardTitle>
        <CardDescription>
          {payload.description ??
            "This step happens inside the Minister extension so the sensitive proof bytes never leave your device."}
        </CardDescription>
      </CardHeader>
