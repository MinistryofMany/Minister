...
// Proactive enrollment + lifecycle management for the anonymous writing key
...
export default async function AnonymousKeyPage() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6 px-4 py-12">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold tracking-tight">Anonymous writing key</h1>
